...
public class customerAccTable {
    ...
    public void updatePanel(){
        ...
        passwordField.setText(accountsTable.getValueAt(accountsTable.getSelectedRow() , 2).toString()) ;
        roles.setSelectedItem(accountsTable.getValueAt(accountsTable.getSelectedRow() , 3).toString()) ;
        ...
        confirm.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                try{
                    ...
                    else if(accountsTable.getValueAt(accountsTable.getSelectedRow() ,3).toString().equals("Manager")){
                        throw new Exception("Cannot update Manager account") ;
                    }

                    accountDTO account = new accountDTO() ;
                    account.setID(accountsTable.getValueAt(accountsTable.getSelectedRow() , 0).toString()) ;
                    account.setUsername(accountsTable.getValueAt(accountsTable.getSelectedRow() , 1).toString()) ;
                    account.setType(roles.getSelectedItem().toString()) ;
